...
<?php
        ...
        else if ((isset($_REQUEST['file']) && isset($module_aff_unique[$_REQUEST['file']]) && $_REQUEST['file'] == $module_aff_unique[$_REQUEST['file']]) || (isset($_REQUEST['page']) && $_REQUEST['page'] == "admin")){
?>
                                        <div id="site1">
...
?>
                        ...
                        <?php if(isset($_REQUEST['file']) && (!isset($complet[$_REQUEST['file']]) || $_REQUEST['file'] != $complet[$_REQUEST['file']])) echo '</div>'; ?>
                        <div id="b-bottom">
                                <div id="bottom">
                                        <div id="footer">
...
<?php
    if (isset($_REQUEST['file']) && (!isset($complet[$_REQUEST['file']]) || $_REQUEST['file'] != $complet[$_REQUEST['file']])) echo '</div>';
}

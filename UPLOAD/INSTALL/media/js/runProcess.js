// Ensure language and i18n object exists (fallback if server i18n script fails to load)
...
var i18nFallback = {
    ...
    success: 'Success',
    failure: 'Failure',
    check_table_integrity: 'Checking table integrity: %s',
    check_table_integrity_error: 'Table integrity check error',
    check_all_table_integrity: 'Checking all table integrity',
    check_table_charset: 'Checking table charset',
    converted_table_success: 'Table %s converted successfully',
    created_table_success: 'Table %s created successfully',
    update_table_success: 'Table %s updated successfully',
    remove_table_success: 'Table %s removed successfully',
    nothing_to_check: 'Nothing to check for table %s',
    no_convert_table: 'No conversion needed for table %s',
    nothing_to_do: 'Nothing to do for table %s',
    update_table_step: 'Updating table %1$s',
    table_convertion: 'Table conversion',
    install_success: 'Installation completed successfully!',
    update_success: 'Update completed successfully!',
    install_failed: 'Installation failed with %d error(s)',
    update_failed: 'Update failed with %d error(s)',
    next: 'Next',
    retry: 'Retry',
    print_error: 'Error',
    created_table_error: 'Error creating table',
    update_table_error: 'Error updating table',
    check_integrity_failed: 'Integrity check failed with %d error(s)',
    converted_table_failed: 'Table conversion failed with %d error(s)'
};

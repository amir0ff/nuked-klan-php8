...
if ($visiteur >= $level_access && $level_access > -1){
    ...
    function add_sug($data){
        ...
        $module_escaped = mysql_real_escape_string($_REQUEST['module']);
        $sql = mysql_query("INSERT INTO " . SUGGEST_TABLE . " ( `module` , `user_id` , `proposition` , `date` ) VALUES ( '" . $module_escaped . "' , '" . $author . "' , '" . $content . "' , '" . $date . "' )");

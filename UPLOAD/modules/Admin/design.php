                ...
                <ul id="main-nav">
                    ...
                    <li>
                        ...
                        foreach ($modules as $value) {
                            ...
                            {
                                if (isset($_REQUEST['file']) && isset($_REQUEST['page']) && $_REQUEST['file'] == $temp[1] and $_REQUEST['page'] == 'admin') $modulecur = true;
                            } // END if
                            
                        } // END foreach
                        
                        $modulecur = isset($modulecur) ? $modulecur : false; // Fixed: Initialize $modulecur

...
// Compatibility functions for deprecated PHP functions
if (!function_exists('get_magic_quotes_gpc')) {
    function get_magic_quotes_gpc() {
        return false; // Always false in PHP 7.1+
    }
}

if (!function_exists('set_magic_quotes_runtime')) {
    function set_magic_quotes_runtime($new_setting) {
        return false; // No-op in PHP 7.0+
    }
}
...
$query_string = strtolower(rawurldecode(isset($_SERVER['QUERY_STRING']) ? $_SERVER['QUERY_STRING'] : ''));
